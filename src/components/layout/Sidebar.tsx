...
import {
  LayoutDashboard, Ticket, ShieldAlert, BarChart2, Users, Settings,
  FileText, Bell, Globe, ChevronDown, ChevronRight, Zap
} from 'lucide-react'
      ...
      <div className="border-t border-white/10 p-3">
        <div className="flex items-center gap-2.5 px-2 py-1.5 rounded-md hover:bg-white/5 cursor-pointer">
          ...
          <div className="min-w-0">
            <div className="text-xs font-medium text-white truncate">Alice Nkosi</div>
