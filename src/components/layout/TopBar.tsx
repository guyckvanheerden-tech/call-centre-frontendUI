      ...
      <div className="flex items-center gap-1 ml-auto">
        ...
        <div className="relative ml-1" ref={menuRef}>
          ...
          >
            ...
            <span className="text-sm text-gray-700 hidden sm:block">Alice Nkosi</span>
          ...
          {userMenuOpen && (
            <div className="absolute top-full right-0 mt-1.5 w-52 bg-white border border-gray-200 rounded-xl shadow-lg overflow-hidden z-50">
              <div className="px-4 py-3 border-b border-gray-100">
                <div className="text-xs font-semibold text-gray-800">Alice Nkosi</div>
                <div className="text-xs text-gray-400 mt-0.5">alice@company.com</div>
                <div className={cn(
              ...
              <button
                onClick={() => {
                  updateUser(LOGGED_IN_USER_ID, { online: !isOnline })
                  setUserMenuOpen(false)
                }}
              ...
              <div className="border-t border-gray-100">
                <button
                  onClick={() => {
                    updateUser(LOGGED_IN_USER_ID, { online: false })
                    setUserMenuOpen(false)
                  }}
